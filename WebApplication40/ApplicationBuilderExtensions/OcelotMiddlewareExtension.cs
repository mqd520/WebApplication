...
using WebApplication40.Middlewares;

namespace WebApplication40.ApplicationBuilderExtensions
{
    public static class OcelotMiddlewareExtension
    {
        public static RequestDelegate UseCustomOcelot(this IApplicationBuilder app, OcelotPipelineConfiguration configuration)
        {
            ...
            app.UseMiddleware<RemoveHttpHeaderMiddleware>();
